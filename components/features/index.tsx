            ...
            <div className="max-w-[1400px] mx-auto px-4 py-16 lg:py-24">
                ...
                <div className="relative">
                    <div
                        ...
                        tabIndex={0}
                        onKeyDown={onKeyDown}
                        className="flex gap-6 items-center overflow-x-auto thin-scrollbar scroll-smooth snap-x snap-mandatory -mx-2 px-2"
                            ...
                            >
                                ...
                                >
                                    <div className="relative aspect-video overflow-hidden">
                                        {!imageLoadStates[project.title] && <ImageSkeleton className="absolute inset-0" aspectRatio="video" />}
                                        <ImageWithFallback
                    ...
                    {canScrollRight && (
                        <button
                            ...
                            className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-black/20 flex items-center justify-center backdrop-blur-xs transition-opacity hover:bg-black/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60"
                            aria-label="Suivant"
                        >
